	...
	<div class="main-container">
		...
		<div id="getstarted">
			...
			<div><ul class="nav nav-tabs">
              <li class="active"><a href="#DraftDaily" data-toggle="tab" aria-expanded="true">DraftDaily</a></li>
              <li class=""><a href="#DFSCoin" data-toggle="tab" aria-expanded="false">DFSCoin</a></li>
            </ul></div>
			<div class="tab-content">
              <div class="tab-pane active" id="DraftDaily">
			...
			<div class="page-header">
				<h3 class="str"><b>Steps to be follow : </b></h3>
				<ol>
					<li>Register to our APIs Portal <a class="str" href="http://api.draftdaily.com">api.draftdaily.com</a></li>
					<li>Create A New App for your domain.</li>
					<li>Fill all required information for app creation.</li>
					<li>After successfully app created it will listed in your App list section as pending for approval.</li>
					<li>After successfully app created it will automatically proccessed for <a class="str" href="javascript:void(0);">draftdaily</a> admin approval.</li>
					<li>Once App will approved by <a class="str" href="javascript:void(0);">draftdaily</a> admin its status going to live and now you use the app.</li>
					
					<li>Base_url : <a class="str" href="javascript:void(0);">http://api.draftdaily.com/api/v1</a></li>
					<li>Get building.</li>
		...
		<div id="get-applicable-match">
			...
			<div class="page-header">
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="DFSCoin">
                <!-- The timeline -->
                <div id="Deposite Response">
			
			<h2 class="str"><b>Deposit</b></h2>
			<div class="line"> </div>
			
			<p>This API is used to deposit DFSCoin.</p>
			...
			<div class="page-header">
				<table class="table table-bordered">
					<tbody>
						<tr>
							<th class="str" scope="row">URL</th>
							<td><font color="grey"> http://139.162.189.133:3001/</font>/transaction/details</td>				  
						</tr>
						<tr>
							<th class="str" scope="row">Method</th>
							<td>POST</td>					 
				...
				<pre class="prettyprint str">
				{
					"txid":"ksdfksdfjl;ksadjfksald;jflksadjflksdlfj;lsdkfj"
				}
				</pre>
				...
				{
"help":{
"txid":"ca5d8e7a65e8165a57d3903ad6642a3d15e74dafbedfad24d158b33da4cbf823",
"version":1,
"time":1507368538,
"locktime":0,
"vin":[
{
"txid":"e589eb0cdb7c551375250574c8f6fb44f88c7c18754d65bc3ab0e3003bcde01d",
"vout":0,
"scriptSig":{
"asm":"304402206afb0d75a3290d439dcceeb796015a5212bdee3965cad3ef9410ec64d04af99d022022729280556f198c0d2630c596498b3d2964a100344de54266e7a2d9fb9b107d01 033b61a6d1d347bb42b4ae1734c895d25db5d2fbb8dcd6e3d7b2db104dba6b353e",
"hex":"47304402206afb0d75a3290d439dcceeb796015a5212bdee3965cad3ef9410ec64d04af99d022022729280556f198c0d2630c596498b3d2964a100344de54266e7a2d9fb9b107d0121033b61a6d1d347bb42b4ae1734c895d25db5d2fbb8dcd6e3d7b2db104dba6b353e"
},
"sequence":4294967295
}
],
...
"n":0,
"scriptPubKey":{
"asm":"OP_DUP OP_HASH160 1827577a7bc9fd5f3f9d4c19d5867a4500b03a2b OP_EQUALVERIFY OP_CHECKSIG",
"reqSigs":1,
"type":"pubkeyhash",
"addresses":[
"D7LotNZJrecpa6x645y5NKrhT7rDHEEnN7"
]
}
},
{
...
"n":1,
"scriptPubKey":{
"asm":"OP_DUP OP_HASH160 4cb5af56b4d07ce6526d5be3cad01fa62adef30c OP_EQUALVERIFY OP_CHECKSIG",
"reqSigs":1,
"type":"pubkeyhash",
"addresses":[
"DC8hYXWfoTRVdXPXAwCgVK7jKS9sxRy5KU"
]
}
}
],
...
"fee":-0.0001,
"confirmations":304,
"blockhash":"8835d7595fffa1e5d460857eb1f96a13e27ee19316470ab8a94ee3c8df8b7b8c",
"blockindex":2,
"blocktime":1507368599,
"timereceived":1507368538,
"comment":"sendtoaddress example",
"to":"Nemo From Example.com",
"details":[
{
"account":"",
"address":"DC8hYXWfoTRVdXPXAwCgVK7jKS9sxRy5KU",
"category":"send",
"amount":-0.01,
"fee":-0.0001
}
		        ...
		        <div id="Withdrawal Response">
			
			<h2 class="str"><b>Withdrawal</b></h2>
			<div class="line"> </div>
			
			<p>This API is used to Withdrawal DFSCoin.</p>
			...
			<div class="page-header">
				<table class="table table-bordered">
					<tbody>
						<tr>
							<th class="str" scope="row">URL</th>
							<td><font color="grey"> http://139.162.189.133:3001/</font>v1/api/make/withdraw</td>				  
						</tr>
						<tr>
							<th class="str" scope="row">Method</th>
							<td>POST</td>					 
						...
						<tr>
							...
							<td>
								<ul>
									<li><b>toWallet</b> DFS wallet address</li>
