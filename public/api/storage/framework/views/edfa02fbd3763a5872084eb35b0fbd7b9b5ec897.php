...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(URL::asset('assets/dist/css/AdminLTE.min.css')); ?>">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo e(URL::asset('assets/dist/css/skins/_all-skins.min.css')); ?>">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container"><img alt="logo" class="img-logo-w3 pull-left" id="img-logo-w3" src="/images/logo-s.png" style="width:40px;padding-right:5px;margin-top:5px;">
        <div class="navbar-header">		
          <a href="/" class="navbar-brand"><b>Doctor </b>Application</a>
...
<!-- jQuery 2.2.3 -->
<script src="<?php echo e(URL::asset('assets/plugins/jQuery/jquery-2.2.3.min.js')); ?>"></script>
<!-- Bootstrap 3.3.6 -->
...
<!-- FastClick -->
<script src="<?php echo e(URL::asset('assets/plugins/fastclick/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php echo e(URL::asset('assets/dist/js/app.min.js')); ?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo e(URL::asset('assets/dist/js/demo.js')); ?>"></script>
</body>
</html>
