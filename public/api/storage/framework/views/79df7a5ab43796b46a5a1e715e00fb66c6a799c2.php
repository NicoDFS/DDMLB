    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Mr.  <?php echo e(Auth::guard('appuser')->user()->name); ?></p>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo e(Request::path() == 'user/application' || Request::path() == 'user/new-app'  || (Request::is('user/view-app/*')) || (Request::is('user/edit-App/*')) ? 'active' : ''); ?>">
          <a href="#"> 
          ...
          <ul class="treeview-menu"> 
            <li class="<?php echo e(Request::path() == 'user/application'||(Request::is('user/view-app/*'))||(Request::is('user/edit-App/*'))  ? 'active' : ''); ?>">
                <a href="/user/application"><i class="fa fa-circle-o"></i>Application List</a></li>
                <li class="<?php echo e(Request::path() == 'user/new-app' ? 'active' : ''); ?>">
                <a href="/user/new-app"><i class="fa fa-circle-o"></i>Create New App</a></li>
          </ul>
        </li> 
        
        <li class="treeview <?php echo e(Request::path() == 'user/documentation' ? 'active' : ''); ?>">
