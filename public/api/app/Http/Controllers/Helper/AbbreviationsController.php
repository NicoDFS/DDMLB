...
class AbbreviationsController extends Controller{
    ...
    public static function getInstance(){
            ...
            self::$_instance = new AbbreviationsController();
...
//        $nhl['Wsh'] = 'Washington Capitals';
    ...
    public function getMLBAbbreviations(){
		...
		$mlb['Vgk'] = 'Vegas Golden Knights';
		$mlb['Cha'] = 'Charlotte Hornets';
