...
class GameXmlParserController extends Controller{
	...
	private function  __construct() { 
		...
		$this->_NFL = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/nfl-shedule";

		$this->_MLB = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/mlb_shedule";

		$this->_NBA = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/nba-shedule";

		$this->_NHL = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nhl-shedule";
	...
	public static function getInstance(){
		...
		self::$_instance = new GameXmlParserController();
            ...
            if(func_num_args() > 0){
                ...
                switch ($gameName) {
                    ...
                    case 'NFL':
                            ...
                            $data = $this->get_xml_to_object($this->_NFL);
                    ...
                    case 'MLB':
                            ...
                            $data = $this->get_xml_to_object($this->_MLB);
                            ...
                            if(isset($data->category->matches)){
                                ...
                                foreach($data->category->matches as $matches){
                                    ...
                                    $matchTime = strtotime($matches['formatted_date']);
                    ...
                    case 'NBA':
							...
							$data = $this->get_xml_to_object($this->_NBA);   
                    ...
                    case 'NHL': 
                            ...
                            $data = $this->get_xml_to_object($this->_NHL);
            ...
            if(func_num_args() > 0){
                ...
                switch ($gameType) {
                    ...
                    case 'NFL':
                        ...
                        $url['ari'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ari_rosters';

                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/atl_rosters';

                        $url['bal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/bal_rosters';

                        $url['buf'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/buf_rosters';

                        $url['car'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/car_rosters';

                        $url['chi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/chi_rosters';

                        $url['cin'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/cin_rosters';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/cle_rosters';

                        $url['dal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/dal_rosters';

                        $url['den'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/den_rosters';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/det_rosters';

                        $url['gb']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/gb_rosters';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/hou_rosters';

                        $url['ind'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ind_rosters';

                        $url['jac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/jac_rosters';

                        $url['kc']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/kc_rosters';

                        $url['mia'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/mia_rosters';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/min_rosters';

                        $url['no']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/no_rosters';

                        $url['nyg'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/nyg_rosters';

                        $url['nyj'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/nyj_rosters';

                        $url['oak'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/oak_rosters';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/phi_rosters';

                        $url['pit'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/pit_rosters';

                        $url['lac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sd_rosters';

                        $url['sea'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sea_rosters';

                        $url['sf']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sf_rosters';

                        $url['ram'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/stl_rosters';

                        $url['tb']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/tb_rosters';

                        $url['ten'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ten_rosters';    

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/wsh_rosters'; 

                        $url['ne']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ne_rosters';
                         ...
                         foreach ($url as $ukey => $uvalue) {
                             ...
                             if(is_array($teamName) && !empty($teamName)){
                                 ...
                                 if(array_search($ukey, $teamName)){
                                        ...
                                        $data = $this->get_xml_to_object($uvalue);
                    ...
                    case 'MLB':
                        ...
                        $url['ari'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/ari_rosters';

                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/atl_rosters';

                        $url['bal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/bal_rosters';

                        $url['bos'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/bos_rosters';

                        $url['chc'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/chc_rosters';

                        $url['chw'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/chw_rosters';

                        $url['cin'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/cin_rosters';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/cle_rosters';

                        $url['col'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/col_rosters';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/det_rosters';

                        $url['fla'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/fla_rosters';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/hou_rosters'; 

                        $url['kan']    = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/kan_rosters';

                        //$url['KC']  = '';

                        $url['laa'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/laa_rosters';

                        $url['lad'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/lad_rosters';

                        //$url['Mia'] = '';

                        $url['mil'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/mil_rosters';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/min_rosters';

                        $url['nym'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/nym_rosters';

                        $url['nyy'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/nyy_rosters';

                        $url['oak'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/oak_rosters';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/phi_rosters';

                        $url['pit'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/pit_rosters';

                        //$url['SD']  = '';

                        //$url['SF']  = '';

                        $url['sdg'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sdg_rosters';

                        $url['sea'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sea_rosters';

                        $url['sfo'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sfo_rosters';

                        $url['stl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/stl_rosters';

                        //$url['TB']  = '';

                        $url['tam'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tam_rosters';

                        $url['tex'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tex_rosters';

                        $url['tor'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tor_rosters';

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/was_rosters';
...
//                             print"<pre>";print_r($playerListArray);print"</pre>";die;
                    ...
                    case 'NBA':
                        ...
                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/atl_rosters';

                        $url['bos'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/bos_rosters';

//                        $url['Bkn'] = '';

                        $url['cha'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/cha_rosters';

                        $url['chi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/chi_rosters';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/cle_rosters';

                        $url['dal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/dal_rosters';

                        $url['den'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/den_rosters';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/det_rosters';

                        $url['gs'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/gs_rosters';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/hou_rosters';

                        $url['ind'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/ind_rosters';

                        $url['lac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/lac_rosters';

                        $url['lal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/lal_rosters';

                        $url['mem'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mem_rosters';

                        $url['mia'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mia_rosters';

                        $url['mil'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mil_rosters';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/min_rosters';

                        $url['nj'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/nj_rosters';

                        $url['no'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/no_rosters';

                        $url['ny'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/ny_rosters';

                        $url['okc'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/okc_rosters';

                        $url['orl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/orl_rosters';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/phi_rosters';

                        $url['phx'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/phx_rosters';

                        $url['por'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/por_rosters';

                        $url['sac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/sac_rosters';

                        $url['sa'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/sa_rosters';

                        $url['tor'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/tor_rosters';

                        $url['uta'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/utah_rosters';

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/wsh_rosters';
                    ...
                    case 'NHL':
                                ...
                                $url['ana'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/ana_rosters';

                                $url['atl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/atl_rosters';

                                $url['bos'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/bos_rosters';

                                $url['buf'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/buf_rosters';

                                $url['car'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/car_rosters';

                                $url['cbs'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/cbj_rosters';

                                $url['cgy'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/cgy_rosters';

                                $url['chi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/chi_rosters';

                                $url['col'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/col_rosters';

                                $url['dal'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/dal_rosters';

                                $url['det'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/det_rosters';

                                $url['edm'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/edm_rosters';

                                $url['fla'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/fla_rosters';

                                $url['la']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/la_rosters';

                                $url['min'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/min_rosters';

                                $url['mtl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/mtl_rosters';

                                $url['nj']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nj_rosters';

                                $url['nsh'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nsh_rosters';

                                $url['nyi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nyi_rosters';

                                $url['nyr'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nyr_rosters';

                                $url['ott'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/ott_rosters';

                                $url['phi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/phi_rosters';

                                $url['phx'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/phx_rosters';

                                $url['pit'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/pit_rosters';

                                $url['sj']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/sj_rosters';

                                $url['stl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/stl_rosters';

                                $url['tb']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/tb_rosters';

                                $url['tor'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/tor_rosters';

                                $url['van'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/van_rosters';

                                $url['wsh'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/wsh_rosters'; 
                ...
                switch ($gameType) {
                    ...
                    */
                    ...
                    case 'NFL' : {
                        ...
                        $url['ari'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ari_player_stats';

                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/atl_player_stats';

                        $url['bal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/bal_player_stats';

                        $url['buf'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/buf_player_stats';

                        $url['car'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/car_player_stats';

                        $url['chi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/chi_player_stats';

                        $url['cin'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/cin_player_stats';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/cle_player_stats';

                        $url['dal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/dal_player_stats';

                        $url['den'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/den_player_stats';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/det_player_stats';

                        $url['gb']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/gb_player_stats';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/hou_player_stats';

                        $url['ind'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ind_player_stats';

                        $url['jac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/jac_player_stats';

                        $url['kc']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/kc_player_stats';

                        $url['mia'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/mia_player_stats';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/min_player_stats';

                        $url['ne']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ne_player_stats';

                        $url['no']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/no_player_stats';

                        $url['nyg'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/nyg_player_stats';

                        $url['nyj'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/nyj_player_stats';

                        $url['oak'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/oak_player_stats';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/phi_player_stats';

                        $url['pit'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/pit_player_stats';

                        $url['lac']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sd_player_stats';

                        $url['sea'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sea_player_stats';

                        $url['sf']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/sf_player_stats';

                        $url['ram'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/stl_player_stats';

                        $url['tb']  = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/tb_player_stats';

                        $url['ten'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/ten_player_stats';    

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/wsh_player_stats'; 
                    ...
                    case 'MLB':
                        ...
                        $url['ari'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/ari_stats';

                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/atl_stats';

                        $url['bal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/bal_stats';

                        $url['bos'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/bos_stats';

                        $url['chc'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/chc_stats';

                        $url['chw'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/chw_stats';

                        $url['cin'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/cin_stats';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/cle_stats';

                        $url['col'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/col_stats';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/det_stats';

                        $url['fla'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/fla_stats';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/hou_stats'; 

                        $url['kan'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/kan_stats';

                        //$url['KC']  = '';

                        $url['laa'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/laa_stats';

                        $url['lad'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/lad_stats';

                        //$url['Mia'] = '';

                        $url['mil'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/mil_stats';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/min_stats';

                        $url['nym'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/nym_stats';

                        $url['nyy'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/nyy_stats';

                        $url['oak'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/oak_stats';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/phi_stats';

                        $url['pit'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/pit_stats';

                        //$url['SD']  = '';

                        //$url['SF']  = '';

                        $url['sdg'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sdg_stats';

                        $url['sea'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sea_stats';

                        $url['sfo'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/sfo_stats';

                        $url['stl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/stl_stats';

                        //$url['TB']  = '';

                        $url['tam'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tam_stats';

                        $url['tex'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tex_stats';

                        $url['tor'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/tor_stats';

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/was_stats';
...
//                         Print"<pre>";print_r($playerStatsArray);print"</pre>";die;
                    ...
                    case 'NBA':
                        ...
                        $url['atl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/atl_stats';

                        $url['bos'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/bos_stats';

//                        $url['Bkn'] = '';

                        $url['cha'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/cha_stats';

                        $url['chi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/chi_stats';

                        $url['cle'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/cle_stats';

                        $url['dal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/dal_stats';

                        $url['den'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/den_stats';

                        $url['det'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/det_stats';

                        $url['gs'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/gs_stats';

                        $url['hou'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/hou_stats';

                        $url['ind'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/ind_stats';

                        $url['lac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/lac_stats';

                        $url['lal'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/lal_stats';

                        $url['mem'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mem_stats';

                        $url['mia'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mia_stats';

                        $url['mil'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/mil_stats';

                        $url['min'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/min_stats';

                        $url['nj'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/nj_stats';

                        $url['no'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/no_stats';

                        $url['ny'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/ny_stats';

                        $url['okc'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/okc_stats';

                        $url['orl'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/orl_stats';

                        $url['phi'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/phi_stats';

                        $url['phx'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/phx_stats';

                        $url['por'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/por_stats';

                        $url['sac'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/sac_stats';

                        $url['sa'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/sa_stats';

                        $url['tor'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/tor_stats';

                        $url['uta'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/utah_stats';

                        $url['wsh'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/wsh_stats';
                    ...
                    */
                     ...
                     case 'NHL':
                                ...
                                $url['ana'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/ana_stats';

                                $url['atl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/atl_stats';

                                $url['bos'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/bos_stats';

                                $url['buf'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/buf_stats';

                                $url['car'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/car_stats';

                                $url['cbs'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/cbj_stats';

                                $url['cgy'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/cgy_stats';

                                $url['chi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/chi_stats';

                                $url['col'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/col_stats';

                                $url['dal'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/dal_stats';

                                $url['det'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/det_stats';

                                $url['edm'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/edm_stats';

                                $url['fla'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/fla_stats';

                                $url['la']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/la_stats';

                                $url['min'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/min_stats';

                                $url['mtl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/mtl_stats';

                                $url['nj']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nj_stats';

                                $url['nsh'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nsh_stats';

                                $url['nyi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nyi_stats';

                                $url['nyr'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nyr_stats';

                                $url['ott'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/ott_stats';

                                $url['phi'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/phi_stats';

                                $url['phx'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/phx_stats';

                                $url['pit'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/pit_stats';

                                $url['sj']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/sj_stats';

                                $url['stl'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/stl_stats';

                                $url['tb']  =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/tb_stats';

                                $url['tor'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/tor_stats';

                                $url['van'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/van_stats';

                                $url['wsh'] =  'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/wsh_stats'; 
...
//                        ----------------end NFL--------------------
                    ...
                    */    
                    ...
                    case 'NHL':
                        ...
                        $url['Win'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/atl_rosters';
                        ...
                        $url['Arc'] = 'http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/phx_rosters';
		...
		public function get_xml_to_object($feed) {
            ...
            if(func_num_args() > 0){
                ...
                switch ($gameType) {
                    ...
                    case 'NFL': 
						...
						/* $matchDate = "30.11.2017"; */

                        $NFL = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/football/?date=".$matchDate;                        

						

						$data = $this->get_xml_to_object($NFL);
                    ...
                    case 'MLB':
                        ...
                        $MLB = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/baseball/usa?date=".$matchDate;   

						

						$data = $this->get_xml_to_object($MLB);
                        ...
                        if(isset($data->category->match)){
							...
							foreach($data->category->match as $matches){
								...
								if(isset($matches->stats->hitters->hometeam->player)){
									...
									foreach($matches->stats->hitters->hometeam->player as $homehittersPlayers){



										$matchesHitterHomeArray[$i]['name']    = (string)$homehittersPlayers['name'];

										$matchesHitterHomeArray[$i]['pos']     = (string)$homehittersPlayers['pos'];

										$matchesHitterHomeArray[$i]['at_bats'] = (string)$homehittersPlayers['at_bats'];

										$matchesHitterHomeArray[$i]['runs']    = (string)$homehittersPlayers['runs'];

										$matchesHitterHomeArray[$i]['hits']    = (string)$homehittersPlayers['hits'];

										$matchesHitterHomeArray[$i]['doubles'] = (string)$homehittersPlayers['doubles'];

										$matchesHitterHomeArray[$i]['triples'] = (string)$homehittersPlayers['triples'];

										$matchesHitterHomeArray[$i]['home_run'] = (string)$homehittersPlayers['home_runs'];

										$matchesHitterHomeArray[$i]['sac_fly'] = (string)$homehittersPlayers['sac_fly'];

										$matchesHitterHomeArray[$i]['hit_by_pitch'] = (string)$homehittersPlayers['hit_by_pitch'];

										$matchesHitterHomeArray[$i]['runs_batted_in'] = (string)$homehittersPlayers['runs_batted_in'];

										$matchesHitterHomeArray[$i]['walks'] = (string)$homehittersPlayers['walks'];

										$matchesHitterHomeArray[$i]['hitter_strikeouts'] = (string)$homehittersPlayers['strikeouts'];

										$matchesHitterHomeArray[$i]['average'] = (string)$homehittersPlayers['average'];

										$matchesHitterHomeArray[$i]['stolen_bases'] = (string)$homehittersPlayers['stolen_bases'];

										$matchesHitterHomeArray[$i]['on_base_percentage'] = (string)$homehittersPlayers['on_base_percentage'];

										$matchesHitterHomeArray[$i]['slugging_percentage'] = (string)$homehittersPlayers['slugging_percentage'];

										$matchesHitterHomeArray[$i]['id'] = (string)$homehittersPlayers['id'];  
								...
								if(isset($matches->stats->hitters->awayteam->player)){
									...
									foreach($matches->stats->hitters->awayteam->player as $awayhittersPlayers){

										$matchesHitterAwayArray[$j]['name'] = (string)$awayhittersPlayers['name'];

										$matchesHitterAwayArray[$j]['pos'] = (string)$awayhittersPlayers['pos'];

										$matchesHitterAwayArray[$j]['at_bats'] = (string)$awayhittersPlayers['at_bats'];

										$matchesHitterAwayArray[$j]['runs'] = (string)$awayhittersPlayers['runs'];

										$matchesHitterAwayArray[$j]['hits'] = (string)$awayhittersPlayers['hits'];

										$matchesHitterAwayArray[$j]['doubles'] = (string)$awayhittersPlayers['doubles'];

										$matchesHitterAwayArray[$j]['triples'] = (string)$awayhittersPlayers['triples'];

										$matchesHitterAwayArray[$j]['home_run'] = (string)$awayhittersPlayers['home_runs'];

										$matchesHitterAwayArray[$j]['sac_fly'] = (string)$awayhittersPlayers['sac_fly'];

										$matchesHitterAwayArray[$j]['hit_by_pitch'] = (string)$awayhittersPlayers['hit_by_pitch'];

										$matchesHitterAwayArray[$j]['runs_batted_in'] = (string)$awayhittersPlayers['runs_batted_in'];

										$matchesHitterAwayArray[$j]['walks'] = (string)$awayhittersPlayers['walks'];

										$matchesHitterAwayArray[$j]['hitter_strikeouts'] = (string)$awayhittersPlayers['strikeouts'];

										$matchesHitterAwayArray[$j]['average'] = (string)$awayhittersPlayers['average'];

										$matchesHitterAwayArray[$j]['stolen_bases'] = (string)$awayhittersPlayers['stolen_bases'];

										$matchesHitterAwayArray[$j]['on_base_percentage'] = (string)$awayhittersPlayers['on_base_percentage'];

										$matchesHitterAwayArray[$j]['slugging_percentage'] = (string)$awayhittersPlayers['slugging_percentage'];

										$matchesHitterAwayArray[$j]['id'] = (string)$awayhittersPlayers['id'];  
								...
								if(isset($matches->stats->pitchers->hometeam->player)){
									...
									foreach($matches->stats->pitchers->hometeam->player as $homePlayers1){

										$matchesPitcherHomeArray[$k]['name'] = (string)$homePlayers1['name'];

										$matchesPitcherHomeArray[$k]['innings_pitched'] = (string)$homePlayers1['innings_pitched'];

										$matchesPitcherHomeArray[$k]['runs'] = (string)$homePlayers1['runs'];

										$matchesPitcherHomeArray[$k]['hits'] = (string)$homePlayers1['hits'];

										$matchesPitcherHomeArray[$k]['earned_runs'] = (string)$homePlayers1['earned_runs'];

										$matchesPitcherHomeArray[$k]['walks'] = (string)$homePlayers1['walks'];

										$matchesPitcherHomeArray[$k]['strikeouts'] = (string)$homePlayers1['strikeouts'];

										$matchesPitcherHomeArray[$k]['home_runs'] = (string)$homePlayers1['home_runs'];

										$matchesPitcherHomeArray[$k]['pc-st'] = (string)$homePlayers1['pc-st'];

										$matchesPitcherHomeArray[$k]['earned_runs_average'] = (string)$homePlayers1['earned_runs_average'];

										$matchesPitcherHomeArray[$k]['win'] = (string)$homePlayers1['win'];

										$matchesPitcherHomeArray[$k]['loss'] = (string)$homePlayers1['loss'];

										$matchesPitcherHomeArray[$k]['holds'] = (string)$homePlayers1['holds'];

										$matchesPitcherHomeArray[$k]['saves'] = (string)$homePlayers1['saves'];

										$matchesPitcherHomeArray[$k]['id'] = (string)$homePlayers1['id'];  
								...
								if(isset($matches->stats->pitchers->awayteam->player)){
									...
									foreach($matches->stats->pitchers->awayteam->player as $awayPlayers1){

										$matchesPitcherAwayArray[$l]['name'] = (string)$awayPlayers1['name'];

										$matchesPitcherAwayArray[$l]['innings_pitched'] = (string)$awayPlayers1['innings_pitched'];

										$matchesPitcherAwayArray[$l]['runs'] = (string)$awayPlayers1['runs'];

										$matchesPitcherAwayArray[$l]['hits'] = (string)$awayPlayers1['hits'];

										$matchesPitcherAwayArray[$l]['earned_runs'] = (string)$awayPlayers1['earned_runs'];

										$matchesPitcherAwayArray[$l]['walks'] = (string)$awayPlayers1['walks'];

										$matchesPitcherAwayArray[$l]['strikeouts'] = (string)$awayPlayers1['strikeouts'];

										$matchesPitcherAwayArray[$l]['home_runs'] = (string)$awayPlayers1['home_runs'];

										$matchesPitcherAwayArray[$l]['pc-st'] = (string)$awayPlayers1['pc-st'];

										$matchesPitcherAwayArray[$l]['earned_runs_average'] = (string)$awayPlayers1['earned_runs_average'];

										$matchesPitcherAwayArray[$l]['win'] = (string)$awayPlayers1['win'];

										$matchesPitcherAwayArray[$l]['loss'] = (string)$awayPlayers1['loss'];

										$matchesPitcherAwayArray[$l]['holds'] = (string)$awayPlayers1['holds'];

										$matchesPitcherAwayArray[$l]['saves'] = (string)$awayPlayers1['saves'];

										$matchesPitcherAwayArray[$l]['id'] = (string)$awayPlayers1['id'];  
								...
								$matchesStartingAwayPitchersArray[$n]['name'] = (string)$matches->starting_pitchers->awayteam->player['name']; 

								$matchesStartingAwayPitchersArray[$n]['id']   = (string)$matches->starting_pitchers->awayteam->player['id'];
							...
							$mergeArray = array_merge($matchesHitterHomeArray,$matchesHitterAwayArray,$matchesPitcherHomeArray,$matchesPitcherAwayArray,$matchesStartingHomePitchersArray,$matchesStartingAwayPitchersArray);    
                    ...
                    case 'NBA': 
                        ...
                        $NBA = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/bsktbl/nba-scores?date=".$matchDate;

						

						$data = $this->get_xml_to_object($NBA);
						...
						if (isset($data->category->match)) {
							...
							foreach ($data->category->match as $catMatch) {
								...
								//echo "<pre>"; print_r($catMatch); echo "</pre>"; die;
							...
							//echo "<pre>"; print_r($playerStatsDetails); echo "</pre>";	die;
                    ...
                    */    
                    ...
                    case 'NHL':
                            ...
                            $NHL = "http://www.goalserve.com/getfeed/15e8f1be05d64b7799bdc5e133ccaaa6/hockey/nhl-scores?date=".$matchDate;

							

                            $data = $this->get_xml_to_object($NHL);
...
//                }
    ...
    function calculateFppgNFL($playerStat){ //echo "<pre>"; print_r($playerStat); echo "</pre>"; die;
        ...
        if(isset($playerStat['Kicking'])){
            ...
            $playerStat['Kick_score']['ext_points'] = $playerStat['Kicking']['extra_points_made'];

            if(!empty($yrd1decode) && !empty($yrd2decode) && !empty($yrd3decode)){

                $yrds39Points = ($yrd1decode[0]+$yrd2decode[0]+$yrd3decode[0])*3;

                $playerStat['Kick_score']['39yards'] = ($yrd1decode[0]+$yrd2decode[0]+$yrd3decode[0]);

            }

            

            if(isset($playerStat['Kicking']['39yards'])){

                $yrds39Points = $playerStat['Kicking']['39yards'] * 3;
            ...
            if(isset($playerStat['Kicking']['field_goals_from_40_49_yards'])){$yrds49decode = explode("-",$playerStat['Kicking']['field_goals_from_40_49_yards']);
                ...
                $playerStat['Kick_score']['49yards'] = $yrds49decode[0];
            ...
            if(isset($playerStat['Kicking']['field_goals_from_50_yards'])){$yrd50decode =  explode("-",$playerStat['Kicking']['field_goals_from_50_yards']);
                ...
                $playerStat['Kick_score']['50yards'] = $yrd50decode[0];
