...
class Engine_Vault_Acl extends Zend_Acl
{
	public function __construct(){
		...
		$this->add(new Zend_Acl_Resource('authentication'))
			 ...
			 ->add(new Zend_Acl_Resource('authentication::authentication::verify-email'), 'authentication::authentication')
			 ->add(new Zend_Acl_Resource('authentication::authentication::facebookauth'), 'authentication::authentication')
			 ->add(new Zend_Acl_Resource('authentication::authentication::twitter-login'), 'authentication::authentication');
		...
		$this->allow('guest', 'authentication::authentication::index')
			 ...
			 ->allow('guest', 'authentication::authentication::twitter-login')
			 ...
			 ->allow('guest', 'authentication::authentication::verify-email')
		...
		$this->add(new Zend_Acl_Resource('admin::player'), 'admin')
			 ...
			 ->add(new Zend_Acl_Resource('admin::player::player-salary-setting'), 'admin::admin')
		...
		$this->allow('admin', 'admin::player::player-details')
			 ...
			 ->allow('admin', 'admin::player::player-salary-setting')
		...
		$this->allow('admin', 'admin::settings::themes')
		 ...
		 $this->allow('admin', 'admin::store::valid-tickets')
			  ...
			  ->allow('admin', 'admin::store::ticket-handler');			  						$this->add(new Zend_Acl_Resource('admin::api'), 'admin')				->add(new Zend_Acl_Resource('admin::api::app-user-edit'), 'admin::admin')				->add(new Zend_Acl_Resource('admin::api::user-app-list'), 'admin::admin')				->add(new Zend_Acl_Resource('admin::api::change-app-status'), 'admin::admin')				->add(new Zend_Acl_Resource('admin::api::app-user-details'), 'admin::admin');						$this->allow('admin', 'admin::api::app-user-details')				->allow('admin', 'admin::api::app-user-edit')				->allow('admin', 'admin::api::change-app-status')				->allow('admin', 'admin::api::user-app-list');			
		/**
		 * End admin Module
		 */
	 ...
	 ->add(new Zend_Acl_Resource('user::account::withdraw-ajax-handler'), 'user::account')
		...
		$this->add(new Zend_Acl_Resource('cron'))
			 ...
			 ->add(new Zend_Acl_Resource('cron::cron::update-player-salary'),'cron::cron')
		...
		$this->allow('guest','cron::cron::players-stats')
			 ...
			 ->allow('guest','cron::cron::update-player-salary')
